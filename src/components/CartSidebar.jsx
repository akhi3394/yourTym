...
const CartSidebar = ({ cartItems, onUpdateQuantity, onRemoveItem, total }) => {
  return (
    <div className="w-[300px] h-[494px] bg-white border-l border-gray-200 flex flex-col rounded-[10px]">
      ...
      <div className="h-[494px] overflow-y-auto custom-scrollbar p-4">
        {cartItems.length === 0 ? (
      ...
      {cartItems.length > 0 && (
        <div className="p-4 border-t border-gray-200 mt-auto">
          <button className="w-full  text-[#ffffff] bg-[#FF5534] font-semibold py-3 rounded-lg transition-colors flex justify-between px-3">
