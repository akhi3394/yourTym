...
const SuccessModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-sm w-full p-8 text-center relative">
        {/* Close Icon */}
        <button
          onClick={onClose}
        ...
        <div className="relative mb-6">
          ...
          {/* Success Icon */}
          <div className="w-20 h-20 bg-[#FF5534] rounded-full flex items-center justify-center mx-auto shadow-lg relative z-10">
