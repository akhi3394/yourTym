                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full flex items-center justify-between text-left hover:bg-red-100 transition-colors px-3 py-3"
                    >
            ...
            <div className="flex items-center space-x-3">
              <div className="flex-1">
                <input
                  ...
                  placeholder="Message"
                  className="w-full px-4 bg-transparent py-1 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                />
              </div>
              <button
